...
function gameOver(a){
    let gameOverAlertElmt =  "<b>Juego terminado </b><br><br> El jugador " + span[a].dataset.player.toUpperCase() + ' Gano !!! <br><br>' + restartButton;
    let div = document.createElement('div');
    div.className = "alert";
    div.innerHTML = gameOverAlertElmt;
...
function draw() {
    let drawAlertElement = '<b>Dibuja!!!</b><br><br>' + restartButton;
    let div = document.createElement("div");
    div.className = "alert";
